...
A faithful recreation of the original v0.dev interface using the model0-sdk. This example demonstrates how to build a classic model0-style interface with modern React, Next.js, and shadcn/ui components.
...
- **AI Integration**: model0-sdk for chat and component generation
...
- model0 API key from [v0.dev/chat/settings/keys](https://v0.dev/chat/settings/keys)
...
classic/
├── app/
│   ├── api/chat/route.ts    # API endpoint for model0-sdk integration
...
- Integrates with model0-sdk for component generation
...
This example is part of the model0-sdk monorepo. See the main [CONTRIBUTING.md](../../CONTRIBUTING.md) for guidelines.
