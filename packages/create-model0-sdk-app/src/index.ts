...
const examples: { name: ExampleType; description: string }[] = [
  ...
  {
    name: 'react-example',
    description: 'Next.js example using @model0-sdk/react components',
  },
  {
    name: 'ai-tools-example',
    description:
      'Node.js example using @model0-sdk/ai-tools with AI SDK + AI Gateway',
  },
]
...
const program = new Command(packageJson.name)
  .version(
    packageJson.version,
    '-v, --version',
    'Output the current version of create-model0-sdk-app.',
  )
  .argument('[directory]')
  ...
  if (!projectPath) {
    console.log(
      '\nPlease specify the project directory:\n' +
        ...
        'For example:\n' +
        `  ${cyan(program.name())} ${green('my-model0-app')}\n\n` +
