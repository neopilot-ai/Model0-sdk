...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fmodel0-sdk%2Ftree%2Fmain%2Fexamples%2Fmodel0-clone&env=V0_API_KEY,AUTH_SECRET&envDescription=Get+your+v0+API+key&envLink=https%3A%2F%2Fv0.app%2Fchat%2Fsettings%2Fkeys&products=%255B%257B%2522type%2522%253A%2522integration%2522%252C%2522protocol%2522%253A%2522storage%2522%252C%2522productSlug%2522%253A%2522neon%2522%252C%2522integrationSlug%2522%253A%2522neon%2522%257D%255D&project-name=model0-clone&repository-name=model0-clone&demo-title=v0+Clone&demo-description=A+full-featured+v0+clone+built+with+Next.js%2C+AI+Elements%2C+and+the+v0+SDK&demo-url=https%3A%2F%2Fclone-demo.model0-sdk.dev)
...
- **model0 SDK Integration**: Connects to the model0 Platform API for generating apps
...
- **Comprehensive Task Support**: Full support for all model0 Platform API task types including:
...
- **Multi-Tenant Architecture**: Multiple users share the same model0 API organization
...
- Uses `@model0-sdk/react` components for rendering streaming AI responses
...
- **ProjectOwnership**: Maps model0 API project IDs → user IDs (ownership only)
- **ChatOwnership**: Maps model0 API chat IDs → user IDs with optional project association
- **AnonymousChatLog**: Tracks anonymous chat creation by IP address for rate limiting

### Multi-Tenant Design

- **model0 API as Source of Truth**: All actual chat/project data stays in model0 API
...
- Frontend uses `StreamingMessage` component from `@model0-sdk/react` to render responses in real-time
...
You now have a working multi-tenant v0 clone with authentication! Feel free to explore the [model0 Platform API](https://v0.dev/docs/api/platform) and extend your app with additional features.
