      ...
      <div className="max-w-5xl mx-auto px-4 py-6">
        ...
        <div className="mb-8 border border-green-400 rounded bg-black">
          <div className="flex items-center gap-2 px-4 py-2 bg-green-400 text-black">
            ...
            <span className="ml-4 font-bold">model0-sdk-terminal</span>
          </div>
          <div className="p-4">
            <div className="mb-2">
              <span className="text-green-300">user@model0-sdk:~$</span>{' '}
              <span className="text-white">./run-ai-chat</span>
            </div>
            <div className="text-green-300">
              [INFO] Initializing @model0-sdk/react terminal interface...
            </div>
            <div className="text-green-300">
        ...
        <footer className="mt-12 border-t border-green-600 pt-6">
          <div className="text-center space-y-2">
            ...
            <div className="text-xs text-green-600">
              Powered by{' '}
              <a
                href="https://github.com/neopilot-ai/model0-sdk"
