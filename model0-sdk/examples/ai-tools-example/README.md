...
This example demonstrates how to use `@model0-sdk/ai-tools` with the AI SDK to interact with the model0 platform programmatically.
...
3. **Get your API keys:**
   - **model0 API Key**: Get from [v0.dev](https://v0.dev) account settings
