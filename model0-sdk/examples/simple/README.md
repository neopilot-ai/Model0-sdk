...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fmodel0-sdk%2Ftree%2Fmain%2Fexamples%2Fsimple&env=V0_API_KEY&envDescription=Get+your+v0+API+key&envLink=https%3A%2F%2Fv0.app%2Fchat%2Fsettings%2Fkeys&project-name=simple&repository-name=simple&demo-title=Simple+v0&demo-description=The+simplest+way+to+use+v0+-+just+prompt+and+see+your+app&demo-url=https%3A%2F%2Fsimple-demo.model0-sdk.dev)
...
2. **Configure environment:**
   ...
   - Get your model0 API key from [v0.dev/settings](https://v0.dev/settings)
...
- **API Integration:** model0-sdk for Platform API communication
...
- [model0 Platform API Documentation](https://v0.dev/docs/api/platform)
