...
AI SDK tools for the model0 Platform API. This package provides a comprehensive collection of tools that can be used with the AI SDK to interact with v0's API endpoints, enabling AI agents to create, manage, and deploy v0 projects and chats.
...
```bash
npm install @model0-sdk/ai-tools ai zod@^3.23.8
```
...
import { v0Tools } from '@model0-sdk/ai-tools'
...
```typescript
import { v0ToolsByCategory } from '@model0-sdk/ai-tools'
...
```typescript
import { createChatTools, createProjectTools } from '@model0-sdk/ai-tools'
...
Set your model0 API key as an environment variable:
...
```typescript
import type { V0ToolsConfig } from '@model0-sdk/ai-tools'
...
All tools include proper error handling and will throw descriptive errors if the model0 API returns an error:
...
This package is part of the model0 SDK monorepo. See the main repository for contribution guidelines.
