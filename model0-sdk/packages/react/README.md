...
Headless React components and hooks for rendering content from the model0 Platform API.
...
```bash
npm install @model0-sdk/react
# or
yarn add @model0-sdk/react
# or
pnpm add @model0-sdk/react
```
...
```tsx
import { Message, StreamingMessage } from '@model0-sdk/react'
...
```tsx
import { useMessage, useStreamingMessageData } from '@model0-sdk/react'
...
```tsx
import { useMessage } from '@model0-sdk/react'
...
The package automatically handles all model0 Platform API task types:
...
```tsx
import { Message } from '@model0-sdk/react'
  ...
  return (
    <Message
      ...
      components={{
        ...
        // Override model0-specific components
...
```tsx
import { useMessage, useIcon } from '@model0-sdk/react'
