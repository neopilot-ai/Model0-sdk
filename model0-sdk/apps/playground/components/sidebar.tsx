          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-xl font-bold text-foreground">
                model0 SDK Playground
              </h1>
              <p className="text-xs text-muted-foreground mt-1">
                Explore, test, and debug the model0 Platform API
              </p>
            </div>
            {onClose && (
              <button
        ...
        <Dialog open={showApiKeyDialog} onOpenChange={setShowApiKeyDialog}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Please enter your model0 API key to make requests.
              </DialogDescription>
            </DialogHeader>
            <div className="py-4">
              <input
                ...
                placeholder="Enter your model0 API key"
